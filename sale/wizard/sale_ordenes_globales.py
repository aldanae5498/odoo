...
class PosDetails(models.TransientModel):
    ...
    _name = 'sale.ordenes.globales.wizard'
    _description = 'Reporte de Órdenes Globales'
    ...
    def generate_report(self):
        ...
        return self.env.ref('sale.sale_ordenes_globales_report').report_action([], data=data)
