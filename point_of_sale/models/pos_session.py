...
# Python 3 convention is to use absolute imports:
# from . import Tfhka
# from . import TfhkaCommon
# from . import serial
...
class PosSession(models.Model):
    ...
    # Método para obtener el precio actual del dólar (19/12/2021):
    @api.model
...
class ImpresoraFiscal():
    ...
    def abrir_puerto(self):
        ...
        try:
            resp = self.printer.OpenFpctrl(str("COM3"))
            if resp:
...
# Instanciando clase de la Impresora Fiscal
impresora = ImpresoraFiscal()
# impresora.abrir_puerto()
impresora.imprimir_ReporteX()
"""
