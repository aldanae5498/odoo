odoo.define('point_of_sale.PaymentScreen', function (require) {
    ...
    class PaymentScreen extends PosComponent {
        ...
        generarFacturaTxt() {
            ...
            let nombre_cliente = cliente.name;
            let direccion_cliente = cliente.address;
            let telefono_cliente = cliente.phone;

            let datos_txt = nombre_cliente + '\n' + direccion_cliente + '\n' + telefono_cliente + '\n\n\n';
            ...
            for(let i=0; i<detalle_productos.length; i++) {
                ...
                let full_product_name = datosRow['full_product_name'];
                ...
                datos_productos += barcode + '\n' + quantity + 'x' + full_product_name + '-------> ' + sub_total + '\n';
            }
        ...
        */
        ...
        async validateOrder(isForceValidate) {
            ...
            // UPDATE 16-02-2022:
            let order = this.currentOrder;
            this.currentOrder.imprimirTxt(order, 0);
            // ===================================================================================== //
            // ===================================================================================== //
